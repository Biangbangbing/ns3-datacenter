...
int main(int argc, char *argv[])
{
	...
	std::string confFile = "/home/bianying/project/huawei2024/ns3/ns3-datacenter/simulator/ns-3.39/examples/WRdma/config-burst.txt";
	std::cout << confFile;
	CommandLine cmd;
	...
	else if (cc_mode == 15) // wrdma,use ts
		IntHeader::mode = IntHeader::TS;
